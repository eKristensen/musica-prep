...
| | |
|---|---|
| bundle | `bluos-probe-20260910T225109` |
| date | 2026-09-10 |
...
|---|---|---|---|---|---|
| `C-19-lsdp-unicast-R` | **INCONCLUSIVE** | an R query sent by unicast is answered | vendor wire format; no client sends it | 12.1 | `004-discovery`, `006-discovery` |
...
```markdown
| `C-19-lsdp-unicast-R` | an R query sent by unicast is answered | vendor wire format; no client sends it | INCONCLUSIVE | 2026-09-10, fw 4.16.22, schema 34 | `UDP :11430LSDP R unicast to player A (T-26)` ->  | bluos-probe-20260910T225109: 004-discovery, 006-discovery |
```
