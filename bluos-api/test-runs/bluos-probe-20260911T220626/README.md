...
`bluos-probe.py 1.6` on 2026-09-11T22:06:26.
...
11 state-changing request(s) were issued against player(s) A, B, D, touching
these endpoints:

  `/AddSlave`, `/Preset`, `/RemoveSlave`, `/SetMaster`, `/Volume`
