...
`bluos-probe.py 1.4` on 2026-09-10T22:54:27.
...
116 state-changing request(s) were issued against player(s) A, B, C, D, touching
these endpoints:

  `/AddSlave`, `/Name`, `/Pause`, `/Play`, `/Preset`, `/RemoveSlave`, `/Repeat`, `/SetMaster`, `/Shuffle`, `/SlaveVolume`, `/Sleep`, `/Sync`, `/Volume`, `/setting`
