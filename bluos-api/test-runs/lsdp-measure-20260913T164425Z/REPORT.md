...
`lsdp-static` v1.0 `measure` on 2026-09-13T16:44:25.872Z.
...
| | min | median | p95 | max |
|---|---:|---:|---:|---:|
| first player (ms) | 0 | 0 | 1 | 1 |
| all players (ms) | 0 | 1 | 2 | 2 |
...
|---|---:|---:|---:|---:|---:|
| 192.0.2.11 [02000000000b] Room-A 0x0001+0x0004 | 10/10 | 0 | 0 | 1 | 1 |
| 192.0.2.12 [02000000000c] Room-B 0x0001+0x0004 | 10/10 | 0 | 0 | 1 | 1 |
| 192.0.2.13 [02000000000d] Room-C 0x0001+0x0004 | 10/10 | 0 | 1 | 2 | 2 |
| 192.0.2.14 [02000000000e] Room-D 0x0001+0x0004 | 10/10 | 0 | 1 | 2 | 2 |
